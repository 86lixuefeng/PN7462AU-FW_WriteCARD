...
======================================================
  ...
  - This software project requires NxpNfcRdLib v05.21.00 or later.
...
===============================================
  ...
  and fail indicated by Red LED (except in the case of Raspberry Pi).
  1) CLEV6630B 2.0 or PNEV5180B v2.0 Customer Evaluation Board LED indications:
     - Red LED - LD201
     - Green LED - LD203 Success: Green LED On, 500 milli sec delay and LED Off
       Fail : Red LED On, 500 milli sec delay and LED Off
  2) PN7462AU v2.1 Customer Evaluation Board LED indications:
     - Red LED - LED8
     - Green LED - LED9 Success: Green LED On, 500 milli sec delay and LED Off
       Fail : Red LED On, 500 milli sec delay and LED Off
  3) FRDM-K82F Board LED indications:
     - Red LED - D3 RGB
     - Green LED - D3 RGB Success: Green LED On, 500 milli sec delay and LED
       Off Fail : Red LED On, 500 milli sec delay and LED Off
  4) Raspberry Pi: Test success and fail indicated by Green LED
     - Green LED - ACT Success: Green LED On, 2 sec delay and LED Off Fail :
       Green LED Toggles every 250 milli sec for 2 sec and LED Off
